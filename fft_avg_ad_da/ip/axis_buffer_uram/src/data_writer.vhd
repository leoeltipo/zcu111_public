...
entity data_writer is
    ...
    (
        ...
        -- AXI Stream I/F.
		tdata		: in std_logic_vector (B-1 downto 0);				
		tuser		: in std_logic_vector (15 downto 0);
		tlast		: in std_logic;
		tvalid		: in std_logic;
		...
		mem_di      : out std_logic_vector (63 downto 0);
...
constant BZERO	: Integer := 64 - (B+16);
...
signal zeros		: std_logic_vector (BZERO-1 downto 0) := (others => '0');
